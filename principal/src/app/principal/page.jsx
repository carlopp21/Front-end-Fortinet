    ...
    return (
        <main className="relative min-h-screen bg-gray-100 flex flex-col md:flex-row">
            ...
            <div className="relative w-full lg:w-[55%] h-screen overflow-hidden">
                ...
                {/* Banner logos */}
                <div className="absolute left-1/2 -translate-x-1/2 top-4 xl:left-[45%] xl:top-[85%] xl:w-[700px] w-[90%] max-w-[600px] lg:max-w-[480px] top-[76%] md:top-[81%] md:w-[450px] lg:top-[90%] lg:left-[45%] xl:max-w-[860px]">
                    <Image
            ...
            {/* CTA móvil */}
            <div className="absolute w-[90%] max-w-[500px] z-20 text-center text-white font-bold text-sm top-[55%] left-1/2 transform -translate-x-1/2 sm:top-[58%] md:top-[63%] md:text-base lg:text-sm lg:top-[60%] lg:left-[42%] lg:w-[25%] xl:w-[400px] xl:top-[66%] xl:left-[40%]">
                <p>
